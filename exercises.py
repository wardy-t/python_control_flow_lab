...
#         elif  age >=18:
#             print (f"{age} is a valid voting age")
#         else:
...
#         if 0 < age <= 2:
#             age = age * 10
#             print (f"your dog is {age} years old in dog years")
#         elif age > 2:
#             age = (age * 7) + 6
#             print (f"your dog is {age} years old in dog years")
#         else: 
...
# def weather_advice():
#     # Your control flow logic goes here
#     cold = input( 'Is it cold today? Please answer "yes" or "no": ').lower()
#     raining = input( 'Is it raining today? Please answer "yes" or "no": ').lower()
...
#     month = input( 'Please enter the month of the year (Jan-Dec): ').capitalize()
